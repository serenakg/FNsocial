...
- **Founder story** ("Why FemNEST exists", `index.html`): Serena asked for "more context" here — the panel currently has the same two short paragraphs it's had since earlier in the build. This needs more of her actual story in her own words; nothing further was added since fabricating it isn't an option. Drop the expanded copy into `.founder-panel__quote` / `.founder-panel__body` when available.
